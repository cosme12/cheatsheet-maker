...
class SheetWizard(object):
    ...
    def help(self):
        ...
        print("#                                                                #")
        print("##################################################################")
        print("\n{}".format(self.help_string["HELP"]))

        print("\n##################################################################")
        print("\n\t\t\t{}".format(self.help_string["BASIC_HELP"][1]))
        print("\n__________________________________________________________________")
        print("\n{}".format(self.help_string["BASIC_HELP"][2]))
        print("{}".format(self.help_string["BASIC_HELP"][3]))
        print("{}".format(self.help_string["BASIC_HELP"][4]))

        print("\n##################################################################")
        print("\n\t\t\t{}".format(self.help_string["HEADER_HELP"][1]))
        print("\n__________________________________________________________________")
        print("\n{}".format(self.help_string["HEADER_HELP"][2]))

        print("\n##################################################################")
        print("\n\t\t\t{}".format(self.help_string["FOOTER_HELP"][1]))
        print("\n__________________________________________________________________")
        print("\n{}".format(self.help_string["FOOTER_HELP"][2]))
        print("{}".format(self.help_string["FOOTER_HELP"][3]))
        print("{}".format(self.help_string["FOOTER_HELP"][4]))
        print("{}".format(self.help_string["FOOTER_HELP"][5]))

        print("\n##################################################################")
        print("\n\t\t\t{}".format(self.help_string["BLOCKS_HELP"][1]))
        print("\n__________________________________________________________________")
        print("\n{}".format(self.help_string["BLOCKS_HELP"][2]))
        print("{}".format(self.help_string["BLOCKS_HELP"][3]))
        print("{}".format(self.help_string["BLOCKS_HELP"][4]))
        print("\n##################################################################")
        print("\t\tTHANKS FOR USING CHEATSHEET HELP")
        print("##################################################################")
        self.intro()
        self.main_menu()
